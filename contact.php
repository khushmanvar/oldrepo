            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    ...
                    <div class="col-md-12 mt-lg-5 text-center">
                        ...
                        <p class="desc mb-4">Have a question about linear regression? <br>Built an amazing app and want
                            to show it?<br>Or you just want to talk? We love discussing new ideas!</p>
                    ...
                    <form action="contact.php" method="post" class="p-5 bg-white">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12">
                                ...
                                <textarea id="message" cols="30" rows="7" name="msg" class="form-control"
