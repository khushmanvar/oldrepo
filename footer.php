        ...
        <div class="d-block">
            <div class="row">
                <div class="col-md-5">
                    ...
                    <p>CSI is a largest group of computer proffesionals in india. CSI DDU Student branch is a chapter of
                        CSI working in the fields of sharing knowledge and experiences among the students of DDU.</p>
                </div>
                <div class="col-md-3">
                    <h2 class="footer-heading mb-4">Contact Us</h2>
                    <!-- <p class="text-white">Priyavardhan Panchal : <br><a href="tel:+919724810243"
                            style="text-decoration:none">+91 97248 10243</a></p>
                    <p class="text-white">Hetvi Purohit : <br><a href="tel:+919428404192"
                            style="text-decoration:none">+91 94284 04192</a></p> -->
                    <p class="text-white">csiddu2021@gmail.com</p>
                </div>
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="https://www.facebook.com/Computer-Society-of-India-DDU-Student-Branch-328507823907859/"
                                target="_blank" style="text-decoration:none">Facebook</a></li>
                        <li><a href="https://Instagram.com/csi_ddu" target="_blank"
                                style="text-decoration:none">Instagram</a></li>
                        <li class="pt-3">
                            <p class="footer-heading"> Site Hits:
        ...
        <div class="row mt-1 pt-1 text-center">
            <div class="col-md-12">
                <div class="border-top pt-3">
                    <p> Copyright &copy; 2021 | Designed & Developed by CSI DDU Student Branch </p>
                </div>
            </div>
        </div>
    </div>
